...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = $forgot_password_message;
    }
}
?>

<div class="page-banner" style="background-color:#444;background-image: url(assets/uploads/<?php echo $banner_forgot_password; ?>);">
    <div class="inner">
